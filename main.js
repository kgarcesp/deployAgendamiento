...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-KPX2AAKN.js").then((m5) => m5);
...
var routes = [
  __spreadValues({
    path: "lista-precios",
    loadComponent: () => import("./chunk-AYYHIOBH.js").then((m5) => m5.ListaPreciosComponent),
    title: "Lista de Precios"
  }, false ? { \u0275entryName: "src/app/features/lista-precios/components/lista-precios.component.ts" } : {}),
  __spreadValues({
    path: "lista-precios/cargar-excel",
    loadComponent: () => import("./chunk-G56W6OPR.js").then((m5) => m5.ExcelUploadeComponent),
    title: "Cargar Excel"
  }, false ? { \u0275entryName: "src/app/features/lista-precios/components/excel-uploade/excel-uploade.component.ts" } : {}),
  __spreadValues({
    path: "lista-precios/historico",
    loadComponent: () => import("./chunk-HB6NDRPS.js").then((m5) => m5.HistoricoPreciosComponent),
    title: "Hist\xF3rico de Precios"
  }, false ? { \u0275entryName: "src/app/features/lista-precios/components/historico-precios/historico-precios.component.ts" } : {}),
  __spreadValues({
    path: "lista-precios/registro-manual",
    loadComponent: () => import("./chunk-JXD3THDH.js").then((m5) => m5.PrecioFormComponent),
    title: "Registro Manual"
  }, false ? { \u0275entryName: "src/app/features/lista-precios/components/precio-form/precio-form.component.ts" } : {}),
  {
    path: "",
    redirectTo: "lista-precios",
    pathMatch: "full"
  }
];
...
// src/mat-theme.provider.ts
function provideMatTheme() {
  return [
    {
      provide: MAT_SNACK_BAR_DEFAULT_OPTIONS,
      useValue: {
        panelClass: "light-snackbar",
        // Clase global para todos los SnackBars
