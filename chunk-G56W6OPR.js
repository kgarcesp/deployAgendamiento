...
import {
  ListPreciosService
} from "./chunk-UMOFTJVH.js";
import {
  MatSnackBar
} from "./chunk-T2T2KQ62.js";
import {
  ButtonModule,
  RippleModule
...
// src/app/features/lista-precios/components/excel-uploade/excel-uploade.component.ts
function ExcelUploadeComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ExcelUploadeComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 19)(2, "span", 20);
    \u0275\u0275text(3, "Cargando...");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "span", 21);
    \u0275\u0275text(5, "Procesando archivo...");
    \u0275\u0275elementEnd()();
  }
}
function ExcelUploadeComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ExcelUploadeComponent_div_16_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function ExcelUploadeComponent_div_16_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.validarDatos());
    });
    \u0275\u0275text(1, " Validar Datos ");
    \u0275\u0275element(2, "i", 34);
    \u0275\u0275elementEnd();
  }
}
function ExcelUploadeComponent_div_16_th_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ExcelUploadeComponent_div_16_tr_12_td_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r5[column_r4] || "-", " ");
  }
}
function ExcelUploadeComponent_div_16_tr_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275template(1, ExcelUploadeComponent_div_16_tr_12_td_1_Template, 2, 1, "td", 31);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.displayedColumns);
  }
}
function ExcelUploadeComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "div", 25)(2, "div", 26)(3, "h5", 27);
    \u0275\u0275text(4, "Datos del Archivo");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 28);
    \u0275\u0275template(6, ExcelUploadeComponent_div_16_button_6_Template, 3, 0, "button", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "table", 29)(8, "thead", 30)(9, "tr");
    \u0275\u0275template(10, ExcelUploadeComponent_div_16_th_10_Template, 2, 1, "th", 31);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "tbody");
    \u0275\u0275template(12, ExcelUploadeComponent_div_16_tr_12_Template, 2, 1, "tr", 31);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r0.excelData.length > 0);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngForOf", ctx_r0.displayedColumns);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r0.excelData);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Mostrando ", ctx_r0.excelData.length, " registros ");
  }
}
function ExcelUploadeComponent_button_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function ExcelUploadeComponent_button_18_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.validarDatos());
    });
...
var ExcelUploadeComponent = class _ExcelUploadeComponent {
  snackBar;
  router;
  listPreciosService;
  excelData = [];
  ...
  errorMessage = null;
  PROVEEDOR_ID = "1225";
  // ID temporal del proveedor
  editingFields = {};
  constructor(snackBar, router, listPreciosService) {
    this.snackBar = snackBar;
    this.router = router;
    this.listPreciosService = listPreciosService;
  }
  onFileChange(event) {
    this.resetState();
    ...
    fileReader.onload = (e) => {
      try {
        ...
        this.excelData = utils.sheet_to_json(firstSheet);
        if (this.excelData.length > 0) {
          this.displayedColumns = Object.keys(this.excelData[0]);
          this.showSuccess(`${this.excelData.length} registros procesados`);
        }
      } catch (error) {
        this.handleError("Error al procesar el archivo. Verifique el formato.");
      } finally {
  ...
  validarDatos() {
    if (this.excelData.length === 0) {
      this.showError("No hay datos para validar");
      return;
    }
    this.isLoading = true;
    const datosConProveedor = this.excelData.map((item) => __spreadProps(__spreadValues({}, item), {
      PROVEEDOR: this.PROVEEDOR_ID
    }));
    this.listPreciosService.validatePriceListData(datosConProveedor).subscribe({
      next: (response) => {
        if (response.isValid) {
          this.showSuccess("Datos validados correctamente");
          setTimeout(() => this.router.navigate(["/lista-precios/historico"]), 1500);
        } else {
          this.showError(response.errors?.join("\n") || "Errores en la validaci\xF3n");
        }
      },
      error: (err) => this.handleError(err.message || "Error al validar datos"),
  ...
  downloadTemplate() {
    ...
    try {
      ...
      writeFileSync(workbook, "Plantilla_Precios.xlsx");
      this.showSuccess("Plantilla descargada");
    } catch (error) {
      this.handleError("Error al generar plantilla");
    }
  }
  handleError(message) {
    console.log(message);
  ...
  static \u0275fac = function ExcelUploadeComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ExcelUploadeComponent)(\u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ListPreciosService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExcelUploadeComponent, selectors: [["app-excel-uploade"]], decls: 19, vars: 5, consts: [[1, "container"], ["header", "Cargar Lista de Precios"], [1, "card-body"], [1, "upload-section", "mb-4"], [1, "mb-3", "mt-2"], [1, "btn", "btn-outline-success"], [1, "bi", "bi-upload", "me-2"], ["type", "file", "accept", ".xlsx, .xls", 1, "d-none", 3, "change"], [1, "btn", "btn-outline-secondary", "ms-3", 3, "click"], [1, "bi", "bi-download", "me-2"], ["class", "file-info", 4, "ngIf"], ["class", "loading-indicator", 4, "ngIf"], ["class", "alert alert-danger", 4, "ngIf"], ["class", "table-responsive mt-4", 4, "ngIf"], ["class", "btn btn-outline-success ms-3", "style", "width: 100%;", 3, "click", 4, "ngIf"], [1, "file-info"], [1, "badge", "bg-info", "text-dark"], [1, "bi", "bi-file-earmark-excel", "me-1"], [1, "loading-indicator"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "ms-2"], [1, "alert", "alert-danger"], [1, "bi", "bi-exclamation-triangle-fill", "me-2"], [1, "table-responsive", "mt-4"], [1, "row", 2, "margin", "5px"], [1, "col-sm-9"], [1, "mb-3"], [1, "col-sm-3"], [1, "table", "table-striped", "table-hover", "table-bordered"], [1, "table-light"], [4, "ngFor", "ngForOf"], [1, "mt-2", "text-muted"], [1, "btn", "btn-outline-success", "ms-3", 2, "width", "100%", 3, "click"], [1, "bi", "bi-arrow-right-circle"]], template: function ExcelUploadeComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "br");
      \u0275\u0275elementStart(2, "p-card", 1)(3, "div", 2)(4, "div", 3)(5, "div", 4)(6, "label", 5);
      \u0275\u0275element(7, "i", 6);
      \u0275\u0275text(8, "Seleccionar Archivo Excel ");
      \u0275\u0275elementStart(9, "input", 7);
      \u0275\u0275listener("change", function ExcelUploadeComponent_Template_input_change_9_listener($event) {
        return ctx.onFileChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "button", 8);
      \u0275\u0275listener("click", function ExcelUploadeComponent_Template_button_click_10_listener() {
        return ctx.downloadTemplate();
      });
      \u0275\u0275element(11, "i", 9);
      \u0275\u0275text(12, "Descargar Plantilla ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(13, ExcelUploadeComponent_div_13_Template, 4, 1, "div", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275template(14, ExcelUploadeComponent_div_14_Template, 6, 0, "div", 11)(15, ExcelUploadeComponent_div_15_Template, 3, 1, "div", 12)(16, ExcelUploadeComponent_div_16_Template, 15, 4, "div", 13);
      \u0275\u0275element(17, "br");
      \u0275\u0275template(18, ExcelUploadeComponent_button_18_Template, 3, 0, "button", 14);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(13);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.excelData.length > 0);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.excelData.length > 0);
    }
  }, dependencies: [
    ...
    RippleModule,
    RouterModule
  ], styles: ["\n\n.excel-uploader-container[_ngcontent-%COMP%] {\n  max-width: 1200px;\n  margin: 2rem auto;\n  padding: 0 1rem;\n}\n.excel-uploader-container[_ngcontent-%COMP%]   .upload-section[_ngcontent-%COMP%] {\n  padding: 1.5rem;\n  border: 2px dashed var(--surface-border);\n  border-radius: 8px;\n  background-color: var(--surface-ground);\n}\n.excel-uploader-container[_ngcontent-%COMP%]   .upload-section[_ngcontent-%COMP%]   input[type=file][_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  opacity: 0;\n  top: 0;\n  left: 0;\n  cursor: pointer;\n}\n.excel-uploader-container[_ngcontent-%COMP%]   .loading-indicator[_ngcontent-%COMP%] {\n  padding: 1rem;\n  color: var(--primary-color);\n}\n/*# sourceMappingURL=excel-uploade.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ExcelUploadeComponent, [{
    type: Component,
    args: [{ selector: "app-excel-uploade", standalone: true, imports: [
      CommonModule,
      HttpClientModule,
      ButtonModule,
      CardModule,
  ...
  <br>\r
  <p-card header="Cargar Lista de Precios">\r
    <div class="card-body">\r
      <!-- \xC1rea de carga -->\r
      <div class="upload-section mb-4">\r
        <div class="mb-3 mt-2">\r
          <label class="btn btn-outline-success">\r
            <i class="bi bi-upload me-2"></i>Seleccionar Archivo Excel\r
            <input type="file" (change)="onFileChange($event)" accept=".xlsx, .xls" class="d-none">\r
          </label>\r
\r
          <button class="btn btn-outline-secondary ms-3" (click)="downloadTemplate()">\r
            <i class="bi bi-download me-2"></i>Descargar Plantilla\r
          </button>\r
        </div>\r
\r
        <div *ngIf="fileName" class="file-info">\r
          <span class="badge bg-info text-dark">\r
            <i class="bi bi-file-earmark-excel me-1"></i> {{ fileName }}\r
          </span>\r
        </div>\r
      </div>\r
\r
      <!-- Mensajes de estado -->\r
      <div *ngIf="isLoading" class="loading-indicator">\r
        <div class="spinner-border text-primary" role="status">\r
          <span class="visually-hidden">Cargando...</span>\r
        </div>\r
        <span class="ms-2">Procesando archivo...</span>\r
      </div>\r
\r
      <div *ngIf="errorMessage" class="alert alert-danger">\r
        <i class="bi bi-exclamation-triangle-fill me-2"></i> {{ errorMessage }}\r
      </div>\r
\r
      <!-- Tabla de resultados -->\r
      <div *ngIf="excelData.length > 0" class="table-responsive mt-4">\r
        <div class="row" style="margin: 5px;">\r
          <div class="col-sm-9">\r
        <h5 class="mb-3">Datos del Archivo</h5>\r
\r
          </div>\r
           <div class="col-sm-3" >\r
                        <button *ngIf="excelData.length > 0" class="btn btn-outline-success ms-3" style="width: 100%;"  (click)="validarDatos()">\r
        Validar Datos <i class="bi bi-arrow-right-circle"></i>\r
      </button>\r
\r
          </div>\r
        </div>\r
...
\r
        <table class="table table-striped table-hover table-bordered">\r
          <thead class="table-light">\r
            <tr>\r
              <th *ngFor="let column of displayedColumns">{{ column }}</th>\r
            </tr>\r
          </thead>\r
          <tbody>\r
            <tr *ngFor="let row of excelData; let i = index">\r
              <td *ngFor="let column of displayedColumns">\r
                {{ row[column] || '-' }}\r
              </td>\r
            </tr>\r
          </tbody>\r
        </table>\r
        <div class="mt-2 text-muted">\r
          Mostrando {{ excelData.length }} registros\r
        </div>\r
      </div>\r
      <br>\r
      <button *ngIf="excelData.length > 0" class="btn btn-outline-success ms-3" (click)="validarDatos()" style="width: 100%;" >\r
        Validar Datos <i class="bi bi-arrow-right-circle"></i>\r
      </button>\r
\r
    </div>\r
...
\r
\r
</div>`, styles: ["/* src/app/features/lista-precios/components/excel-uploade/excel-uploade.component.scss */\n.excel-uploader-container {\n  max-width: 1200px;\n  margin: 2rem auto;\n  padding: 0 1rem;\n}\n.excel-uploader-container .upload-section {\n  padding: 1.5rem;\n  border: 2px dashed var(--surface-border);\n  border-radius: 8px;\n  background-color: var(--surface-ground);\n}\n.excel-uploader-container .upload-section input[type=file] {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  opacity: 0;\n  top: 0;\n  left: 0;\n  cursor: pointer;\n}\n.excel-uploader-container .loading-indicator {\n  padding: 1rem;\n  color: var(--primary-color);\n}\n/*# sourceMappingURL=excel-uploade.component.css.map */\n"] }]
  }], () => [{ type: MatSnackBar }, { type: Router }, { type: ListPreciosService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExcelUploadeComponent, { className: "ExcelUploadeComponent", filePath: "src/app/features/lista-precios/components/excel-uploade/excel-uploade.component.ts", lineNumber: 26 });
})();
export {
  ExcelUploadeComponent
};
...
*/
//# sourceMappingURL=chunk-G56W6OPR.js.map
